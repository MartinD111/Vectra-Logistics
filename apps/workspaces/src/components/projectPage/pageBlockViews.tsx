...
// Per-kind read-mode view components for project-page blocks. Extracted from
// PageBlockView.tsx (which is now a thin registry-dispatch wrapper) so the page
// block registry can point renderers directly at these components without a
...
export function MiniProgramEmbedView({ block }: { block: MiniProgramBlock }) {
...
export function PeopleView({ block, projectId }: { block: PeopleBlock; projectId: string }) {
...
export function StatCardsView({ projectId }: { block: StatCardsBlock; projectId: string }) {
...
export function KpiGridView({ block, projectId }: { block: KpiGridBlock; projectId: string }) {
...
export function ChartWidgetView({ block, projectId }: { block: ChartBlock; projectId: string }) {
...
export function ActivityTimelineView({ block, projectId }: { block: ActivityTimelineBlock; projectId: string }) {
...
export function ProgramLinkView({ block, projectId }: { block: ProgramLinkBlock; projectId: string }) {
