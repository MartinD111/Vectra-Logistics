...
import { StatusBadge } from '@vectra/data';
import { ApiError } from '@vectra/api-client';
import { useState } from 'react';
import { FileUploader } from '@vectra/data';
import { DocumentList } from '@vectra/data';
...
const LiveTrackingMap = dynamic(() => import('@vectra/data/map').then((m) => ({ default: m.LiveTrackingMap })), { ssr: false });
