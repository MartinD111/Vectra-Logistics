...
-- NOTE: the `documents` table is created by migration
-- 002_realtime_and_documents.sql (unified multi-subject schema with
-- subject/subject_id/company_id/expires_at). It is intentionally NOT defined
-- here — the older booking-scoped definition conflicted with migration 002 and
-- the application code, which uses the 002 schema.
